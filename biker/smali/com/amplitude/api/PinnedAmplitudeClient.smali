...
.method public static declared-synchronized getInstance(Ljava/lang/String;)Lcom/amplitude/api/PinnedAmplitudeClient;
    ...
    .prologue
    .line 183
    const-class v2, Lcom/amplitude/api/PinnedAmplitudeClient;
    ...
    check-cast v0, Lcom/amplitude/api/PinnedAmplitudeClient;

    .line 185
    .local v0, "client":Lcom/amplitude/api/PinnedAmplitudeClient;
    if-nez v0, :cond_0

    .line 186
    new-instance v0, Lcom/amplitude/api/PinnedAmplitudeClient;

    .end local v0    # "client":Lcom/amplitude/api/PinnedAmplitudeClient;
    invoke-direct {v0, p0}, Lcom/amplitude/api/PinnedAmplitudeClient;-><init>(Ljava/lang/String;)V

    .line 187
    .restart local v0    # "client":Lcom/amplitude/api/PinnedAmplitudeClient;
    sget-object v1, Lcom/amplitude/api/PinnedAmplitudeClient;->instances:Ljava/util/Map;
...
.method protected getPinnedCertSslSocketFactory(Lcom/amplitude/api/PinnedAmplitudeClient$SSLContextBuilder;)Ljavax/net/ssl/SSLSocketFactory;
    .locals 4
    .param p1, "context"    # Lcom/amplitude/api/PinnedAmplitudeClient$SSLContextBuilder;
    ...
    iput-object v1, p0, Lcom/amplitude/api/PinnedAmplitudeClient;->sslSocketFactory:Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/amplitude/api/AmplitudeLog;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
...
.method public declared-synchronized initialize(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/amplitude/api/AmplitudeClient;
    ...
    .line 213
    .local v0, "client":Lcom/amplitude/api/PinnedAmplitudeClient;
    new-instance v1, Lcom/amplitude/api/PinnedAmplitudeClient$1;

    invoke-direct {v1, p0, v0}, Lcom/amplitude/api/PinnedAmplitudeClient$1;-><init>(Lcom/amplitude/api/PinnedAmplitudeClient;Lcom/amplitude/api/PinnedAmplitudeClient;)V

    invoke-virtual {p0, v1}, Lcom/amplitude/api/PinnedAmplitudeClient;->runOnLogThread(Ljava/lang/Runnable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
